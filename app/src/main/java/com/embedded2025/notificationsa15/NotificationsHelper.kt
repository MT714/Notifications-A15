...
object NotificationsHelper{
    ...
    fun showNotificationWithActions() {
        ...
        val builder = NotificationCompat.Builder(ctx, CHANNEL_ID_DEFAULT)
            .setSmallIcon(R.drawable.ic_launcher_background)
            .setContentTitle(ctx.getString(R.string.actions_notification_title))
            .setContentText(ctx.getString(R.string.actions_notif_descr))
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setStyle(NotificationCompat.BigTextStyle()
                .bigText(ctx.getString(R.string.actions_notif_descr)))
            .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
            .setDefaults(NotificationCompat.DEFAULT_ALL)
